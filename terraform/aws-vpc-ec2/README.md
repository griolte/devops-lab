...
### Terraform apply
![Terraform Apply](docs/screenshots/08_terraform_apply.png)

### VPC
![VPC](docs/screenshots/01_vpc.png)

### Internet Gateway
![Internet Gateway](docs/screenshots/02_internet_gateway.png)

### Route Table
![Route Table](docs/screenshots/03_route_table.png)

### Subnets
![Subnets](docs/screenshots/04_subnets.png)

### Security Group (Inbound)
![Security Group Inbound](docs/screenshots/05_security_group_inbound.png)

### Security Group (Outbound)
![Security Group Outbound](docs/screenshots/06_security_group_outbound.png)

### EC2 Instance
![EC2 Instance](docs/screenshots/07_ec2_instance.png)
